        ...
        <div class="connection-card">
            <div class="user-info">
                <div class="profile-pic">
                    <img src="data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%232563eb' stroke-width='2'><circle cx='12' cy='8' r='5'/><path d='M20 21v-2a7 7 0 0 0-14 0v2'/></svg>" alt="ProfEuler42">
                </div>
                <div class="user-details">
                    <h3 class="username">ProfEuler42</h3>
                    <div class="interests">
                        <span class="interest-tag">Number Theory</span>
                        <span class="interest-tag">Calculus</span>
                    ...
                    <div class="achievements">Fields Medal Nominee, Published in Mathematics Journal</div>
                    <p class="description">I'm passionate about exploring the connections between number theory and topology. Looking for collaborators on my latest research paper.</p>
                </div>
            </div>
            <div class="action-buttons">
                <button class="accept-btn" onclick="handleRequest(1, 'accept')">Accept</button>
                <button class="reject-btn" onclick="handleRequest(1, 'reject')">Reject</button>
            </div>
        </div>
